    ...
    return (
        <section className={styles["content"]}>
            <div className={styles["legal"]}>
                ...
                <p>
                    We are resent.dev.dev LLC, doing business as resent.dev.dev ("Company," "we," "us," "our"),
                    a company registered in Colorado, United States at 520 Zerex St, Unit 443,
                    Fraser, CO 80442.
                </p>

                <p>
                    We operate the website https://resent.dev.dev (the "Site"), as well as any other
                    related products and services that refer or link to these legal terms (the
                    "Legal Terms") (collectively, the "Services").
                </p>

                <p>
                    You can contact us by email at privacy@resent.dev.dev or by mail to 520 Zerex St, Unit
                    443, Fraser, CO 80442, United States.
                </p>

                <p>
                    These Legal Terms constitute a legally binding agreement made between you,
                    whether personally or on behalf of an entity (&quot;you&quot;), and resent.dev.dev
                ...
                <p>
                    ...
                    to: privacy@resent.dev.dev. If we ever grant you the permission to post, reproduce, or
                ...
                <p>
                    ...
                    https://resent.dev.dev/privacy. By using the Services, you agree to be bound by our
                ...
                <p>
                    resent.dev.dev LLC 520 Zerex St Unit 443 Fraser, CO 80442 United States
                    privacy@resent.dev.dev
                </p>
            </div>
        </section>
    )
